...
import { 
    slh_dsa_sha2_192f as sphincs192f,
    slh_dsa_sha2_192s as sphincs192s
...
const createSphincsVariant = (impl) => ({
    ...
    generatePrivateKey(seed) {
        ...
        return seed || crypto.getRandomValues(new Uint8Array(72));
    },
...
/**
 * SLH-DSA-192 (SPHINCS+-192) signatures
 * @namespace sphincs192
 */
export const sphincs192 = {
    /** Fast variant optimized for speed */
    fast: createSphincsVariant(sphincs192f),
    /** Small variant optimized for size */
    small: createSphincsVariant(sphincs192s)
}; 